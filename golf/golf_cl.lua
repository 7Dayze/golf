...
local holes = {
  [1] = {hole = 1, par = 5, startPos = {x = -1371.3370361328, y = 173.09497070313, z = 57.013027191162}, holePos = {x = -1114.1274169922, y = 220.7924987793, z = 63.8947830200}, mapPos = {x = -1262.5, y = 110.0}, mapAngle = 255, mapZoom = 850},
  [2] = {hole = 2, par = 4, startPos = {x = -1107.1888427734, y = 156.581298828, z = 62.03958129882}, holePos = {x = -1322.0844824219, y = 158.7779296875, z = 56.80027008056}, mapPos = {x = -1192.5, y = 250.0}, mapAngle = 75, mapZoom = 850},
  [3] = {hole = 3, par = 3, startPos = {x = -1312.1020507813, y = 125.8329391479, z = 56.4341888427}, holePos = {x = -1237.417412109, y = 112.9838562011, z = 56.20140075683}, mapPos = {x = -1282.5, y = 75.0}, mapAngle = 255, mapZoom = 200},
  [4] = {hole = 4, par = 4, startPos = {x = -1216.913208007, y = 106.9870910644, z = 57.03926086425}, holePos = {x = -1096.5476855469, y = 7.840227184295, z = 49.73574447631}, mapPos = {x = -1172.5, y = -10.0}, mapAngle = 255, mapZoom = 600},
  [5] = {hole = 5, par = 4, startPos = {x = -1097.859619140, y = 66.41466522216, z = 52.92545700073}, holePos = {x = -957.3782910156, y = -90.40551879882, z = 39.2753639221}, mapPos = {x = -1052.5, y = -110.0}, mapAngle = 255, mapZoom = 850},
  [6] = {hole = 6, par = 3, startPos = {x = -987.7417602539, y = -105.0764007568, z = 39.585887908936}, holePos = {x = -1103.506958007, y = -115.1664349365, z = 40.55868911743}, mapPos = {x = -1052.5, y = -50.0}, mapAngle = 75, mapZoom = 600},
  [7] = {hole = 7, par = 4, startPos = {x = -1117.0194091797, y = -103.8586044311, z = 40.8405838012}, holePos = {x = -1290.636499023, y = 2.7752194213867, z = 49.34057998657}, mapPos = {x = -1202.5, y = 45.0}, mapAngle = 75, mapZoom = 850},
  [8] = {hole = 8, par = 5, startPos = {x = -1272.251831054, y = 38.04283142089, z = 48.72544860839}, holePos = {x = -1034.94187988, y = -83.15206085205, z = 43.0353431701}, mapPos = {x = -1182.5, y = -125.0}, mapAngle = 255, mapZoom = 950},
  [9] = {hole = 9, par = 4, startPos = {x = -1138.319580078, y = -0.1342505216598, z = 47.98218917846}, holePos = {x = -1294.785913085, y = 83.5262557983, z = 53.92817306518}, mapPos = {x = -1182.5, y = 120.0}, mapAngle = 75, mapZoom = 750},
}
local ironSwing = {
...
local attachPropList = {
  ["golfbag01"] =     {model = "prop_golf_bag_01",      bone = 24816, attPos = {x = 0.12, y = -0.3, z = 0.0},   attRot = {x = -75.0, y = 190.0, z = 92.0}},
  ["golfputter01"] =  {model = "prop_golf_putter_01",   bone = 57005, attPos = {x = 0.0, y = -0.05, z = 0.0},   attRot = {x = 90.0, y = -118.0, z =  44.0}},
  ["golfiron01"] =    {model = "prop_golf_iron_01",     bone = 57005, attPos = {x = 0.125, y = 0.04, z = 0.0},  attRot = {x = 90.0, y = -118.0, z = 44.0}},
  ["golfiron03"] =    {model = "prop_golf_iron_01",     bone = 57005, attPos = {x = 0.126, y = 0.041, z = 0.0}, attRot = {x = 90.0, y = -118.0, z = 44.0}},
  ["golfiron05"] =    {model = "prop_golf_iron_01",     bone = 57005, attPos = {x = 0.127, y = 0.042, z = 0.0}, attRot = {x = 90.0, y = -118.0, z = 44.0}},
  ["golfiron07"] =    {model = "prop_golf_iron_01",     bone = 57005, attPos = {x = 0.128, y = 0.043, z = 0.0}, attRot = {x = 90.0, y = -118.0, z = 44.0}},
  ["golfwedge01"] =   {model = "prop_golf_pitcher_01",  bone = 57005, attPos = {x = 0.17, y = 0.04, z = 0.0},   attRot = {x = 90.0, y = -118.0, z = 44.0}},
  ["golfdriver01"] =  {model = "prop_golf_driver",      bone = 57005, attPos = {x = 0.14, y = 0.00, z = 0.0},   attRot = {x = 160.0, y = -60.0, z=  10.0}}
}
local golfCourseBlips = {}
local courseStart = {
  pos = {x = -1359.717, y = 149.866, z = 56.346}
}
-- See here for reference to the boundaries: https://i.imgur.com/6nYGUVp.jpg
local boundary = {
  aPos = {x = -1298.006, y = -29.590, z = 48.0},
  bPos = {x = -1396.552, y = 182.469, z = 58.0},
  cPos = {x = -1267.378, y = 200.031, z = 61.0},
  dPos = {x = -1111.602, y = 239.171, z = 65.0},
  ePos = {x = -1086.187, y = 178.338, z = 61.0},
  fPos = {x = -914.387, y = -104.792, z = 38.0},
  gPos = {x = -1074.646, y = -149.726, z = 38.0},
}
local clubBoundary = {
  pos1 = {x = -1417.509, y = 281.564, z = 150.0},
  pos2 = {x = -881.061, y = -174.898, z = 25.0}
}
local boundaryEqs = {}
local flagProp = nil
...
local rentMarker = {x = -1351.086, y = 130.958, z = 56.239}
...
function Draw3DEstText(x, y, z, text)
  ...
  local pos = GetGameplayCamCoords()
  local dist = Vdist(pos.x, pos.y, pos.z, x, y, z, 1)
...
Citizen.CreateThread(function()
  while true do
    ...
    local dist = Vdist(playerPos.x, playerPos.y, playerPos.z, courseStart.pos.x, courseStart.pos.y, courseStart.pos.z)
    if (dist < 80) then
      DrawMarker(1, courseStart.pos.x, courseStart.pos.y, courseStart.pos.z - 1.5, 0, 0, 0, 0, 0, 0, 1.7, 1.7, 1.7, 0, 255, 120, 145, 0, 0, 0, 0, 0, 0, 0)
      
      if (dist < 1.1) then
        if (isPlayingGolf) then
          Draw3DEstText(courseStart.pos.x, courseStart.pos.y, courseStart.pos.z - 0.5, "Press ~b~E~w~ to end your round of ~g~Golf~w~.")
        else
          Draw3DEstText(courseStart.pos.x, courseStart.pos.y, courseStart.pos.z - 0.5, "Press ~b~E~w~ to start a round of ~g~Golf~w~ for ~g~$500~w~.")
        end
    ...
    local rentDist = Vdist(playerPos.x, playerPos.y, playerPos.z, rentMarker.x, rentMarker.y, rentMarker.z)
    if (rentDist < 80) then
      DrawMarker(1, rentMarker.x, rentMarker.y, rentMarker.z - 1.5, 0, 0, 0, 0, 0, 0, 1.7, 1.7, 1.7, 255, 37, 37, 145, 0, 0, 0, 0, 0, 0, 0)
      if (rentDist < 1.1) then
        Draw3DEstText(rentMarker.x, rentMarker.y, rentMarker.z - 0.5, "Press ~b~E~w~ to rent a Golf Cart for ~g~$500~w~.")
        if (IsControlJustReleased(1, 38) or IsDisabledControlJustReleased(1, 38)) then -- E pressed
...
Citizen.CreateThread(function()
  while true do
    ...
    if ((not IsEntityInArea(ped, clubBoundary.pos1.x, clubBoundary.pos1.y, clubBoundary.pos1.z, clubBoundary.pos2.x, clubBoundary.pos2.y, clubBoundary.pos2.z, 0, 1, 0)) and isPlayingGolf) then
